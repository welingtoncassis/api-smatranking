...
export class DesafiosService {
  ...
  async criarDesafio(criarDesafioDto: CreateDesafioDto): Promise<Desafio> {
    /*
  ...
  async consultarDesafiosDeUmJogador(_id: any): Promise<Array<Desafio>> {
    const jogador = await this.jogadoresService.consultarJogadoresPeloId(_id);
  ...
  async atualizarDesafio(
    _id: string,
    atualizarDesafioDto: UpdateDesafioDto,
  ): Promise<void> {
